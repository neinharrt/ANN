...
class Model
{
  ...
  public:
    ...
    void ComputeTranslationalCv(double *cv, const double &Ttr, const double &Tve)
    {
      return (this->*ComputeTC)(&cv[0], Ttr, Tve);
    };
    void ComputeRotationalCv(double *cv, const double &Ttr, const double &Tve)
    {
      return (this->*ComputeRC)(&cv[0], Ttr, Tve);
    };
    void ComputeVibrationalCv(double *cv, const double &Ttr, const double &Tve)
    {
      return (this->*ComputeVC)(&cv[0], Ttr, Tve);
    };
    void ComputeElectronicCv(double *cv, const double &Ttr, const double &Tve)
    {
      return (this->*ComputeEC)(&cv[0], Ttr, Tve);
    };
  ...
  protected:
    ...
    const std::vector<std::string> species_pack_ = {
        "N",  "O",   "C",   "H",   "Ar",  "Np",  "Op",  "Cp",  "Hp",   "Arp",  "N2",  "O2",  "C2",
        "H2", "NO",  "NH",  "OH",  "CN",  "CO",  "CH",  "SiO", "N2p",  "O2p",  "NOp", "CNp", "COp",
        "C3", "CO2", "C2H", "CH2", "H2O", "HCN", "CH3", "CH4", "C2H2", "H2O2", "e"};
    ...
    const std::vector<std::vector<double>> thetel_ = {
        ...
        {0.0000000000000E+00,
         ...
         4.7335729486892E+04,
         4.8486750264689E+04,
         5.8270426875961E+04},  // C3
        {0.0000000000000E+00,
         4.3163279167378E+04,
         4.7479607084116E+04,
         5.1795935000854E+04,
         6.4744918751068E+04},                       // CO2
